...
public class AutonBlueRelic extends OpMode {
    ...
    public void loop() {
        ...
        if (step <= 2) {
            ...
            telemetry.addData("red color", cs.red());
            step++;
        } else if (step <= 9) {
            jewel.setPosition(0);
            step++;
            ...
            a = -25;
            telemetry.addData("move forward", a);
            telemetry.update();
            moveForward(a);
            step++;
            pause(1000);
            ...
            openClamps();
            step++;
        } else if (step <= 25){//when it reaches 13 it opens clamps
            moveForward(15);
            step++;
            pause(1000);
        } else if (step == 26) {
